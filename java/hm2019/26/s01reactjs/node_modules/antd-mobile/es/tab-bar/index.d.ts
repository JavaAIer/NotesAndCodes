...
declare class AntTabBar extends React.Component<AntTabbarProps, any> {
    ...
    getTabs: () => {
        ...
        icon?: React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)> | {
            uri: string;
        } | undefined;
        selectedIcon?: React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)> | {
            uri: string;
        } | undefined;
        title: string;
